...
#################################################################################
                ...
                torch.save(self.centroids0,"/home/Daniele/codes/vissl/runs/dcv2_ir108_128x128_k9_germany_30kcrops_grey_min-max/checkpoints/centroids0.pt")
                torch.save(self.centroids1,"/home/Daniele/codes/vissl/runs/dcv2_ir108_128x128_k9_germany_30kcrops_grey_min-max/checkpoints/centroids1.pt")
...
################################################################                
                ...
                j = (j + 1) % self.nmb_mbs
#################################################################################
            torch.save(self.assignments,"/home/Daniele/codes/vissl/runs/dcv2_ir108_128x128_k9_germany_30kcrops_grey_min-max/checkpoints/assignments_800ep.pt")
            torch.save(self.indexes,"/home/Daniele/codes/vissl/runs/dcv2_ir108_128x128_k9_germany_30kcrops_grey_min-max/checkpoints/indexes_800ep.pt")
            torch.save(self.distance,"/home/Daniele/codes/vissl/runs/dcv2_ir108_128x128_k9_germany_30kcrops_grey_min-max/checkpoints/distance_800ep.pt")
